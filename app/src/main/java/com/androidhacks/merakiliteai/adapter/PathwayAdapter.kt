...
class PathwayAdapter (private val pathways : List<Pathway>, private val onPathwayClick : (Pathway) -> Unit) : RecyclerView.Adapter<PathwayAdapter.PathwayViewHolder>() {
